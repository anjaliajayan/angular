...
const convertXML2Json = function (xmlData) {
  ...
  // FlightList    
  for (const [key, value] of Object.entries(FlightList.Flight)) {
    FLNodes = {
      "attributes": {
      ...
      "SegmentReferences": {
        "attributes": {
          "OnPoint": value.SegmentReferences.OnPoint,
          "OffPoint": value.SegmentReferences.OffPoint
        },
        "text": value.SegmentReferences["#text"]
      }
    }
  ...
  // FlightSegmentList    
  for (const [key, value] of Object.entries(FlightSegmentList.FlightSegment)) {
  ...
  for (const [key, value] of Object.entries(PriceClassList.PriceClass)) {
    ...
    if (typeof (value.Descriptions) !== "undefined") {
      ...
      if (typeof value.Descriptions.Description !== "undefined") {
        description = value.Descriptions.Description.Text
      }
  ...
  */
  ...
  OFN = {}
  OGN = []
  for (const [key, value] of Object.entries(OffersGroupList)) {
    for ([okey, ovalue] of Object.entries(value)) {
      ...
      AirlineOffers.forEach(AirlineOffer => {
        ...
        Associations.forEach(Association => {
          ...
          FlightSegmentReferences.forEach(FlightSegmentReference => {
            Attr = {
              "ref": FlightSegmentReference.ref
            }
            CAttr = {
            ...
            FS = {
              ...
              "ClassOfService": {
                "Code": {
                  "attributes": CAttr,
                  "text": FlightSegmentReference.ClassOfService.Code["#text"] ? FlightSegmentReference.ClassOfService.Code : ""
                },
                "MarketingName": {
                  "attributes": MAttr,
                  "text": FlightSegmentReference.ClassOfService.MarketingName["#text"] ? FlightSegmentReference.ClassOfService.MarketingName : ""
                },
              }
            }
...
const flightPrice2Json = function (xmlData) {
  ...
  if (Errors) {
    return ("Error in flight price Response", Errors);
  }
  ...
  FlightLists.forEach(Flight => {
    FLNodes = {
      ...
      "SegmentReferences": {
        "attributes": {
          "OnPoint": Flight.SegmentReferences.OnPoint,
          "OffPoint": Flight.SegmentReferences.OffPoint
        },
        "text": Flight.SegmentReferences["#text"]
      }
    }
  ...
  FlightSegments.forEach(FlightSegment => {
    ...
    FSNodes = {
      ...
      "FlightDetail": {
        "FlightDuration": {
          "Value": {
            "text": FlightSegment.FlightDetail.FlightDuration.Value
          }
        }
      }
    }
