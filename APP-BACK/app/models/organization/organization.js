module.exports = (sequilize, type) => {
    var organizationModel = sequilize.define('organisation', {
        ...
        queue_service: type.TEXT,
        pos_rbd: type.TEXT,
        pos_negofares: type.TEXT,

        amex_card: type.TEXT,


        domestictTaxCode: type.STRING,
        domestictTaxPercentage: type.STRING,
        domestictTaxCurrency: type.STRING,
        domestictTaxAirport: type.STRING,
        internationalTaxPercentage: type.STRING,
        nonAirlineTax: type.STRING,
        iata_no: type.STRING,
        amex_details: type.STRING,
