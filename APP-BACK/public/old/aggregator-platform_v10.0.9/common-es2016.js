...
let BookingsService = class BookingsService {
    ...
    ancillariesServiceListRequest(ticket) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _flight_search_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./flight-search.service */ "./src/app/shared/services/flight-search.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FlightSearchService", function() { return _flight_search_service__WEBPACK_IMPORTED_MODULE_1__["FlightSearchService"]; });

/* harmony import */ var _bookings_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bookings.service */ "./src/app/shared/services/bookings.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BookingsService", function() { return _bookings_service__WEBPACK_IMPORTED_MODULE_2__["BookingsService"]; });
...
let ProfileManagementService = class ProfileManagementService {
    ...
    NewTravellerProfile(data) {
        return this.http.post(`${this.url}/api/create-new-traveller-profile`, JSON.stringify(data), this.httpOptions)
    ...
    GetAllTraveller(travellID, limit, pageIndex) {
        return this.http.get(`${this.url}/api/fetch-all-traveller-profile?page=${1}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    }
    // GET ALL
    ...
    UpdateTravellerProfile(id, data) {
        return this.http.put(`${this.url}/api/update-new-traveller-profile?traveller_profile_id=` + id, JSON.stringify(data), this.httpOptions)
    ...
    DeleteTravellerById(id) {
        return this.http.delete(`${this.url}/api/remove-traveller-profile?traveller_profile_id=` + id, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
    }
