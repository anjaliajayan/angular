...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewTravellerProfileRoutingModule", function() { return NewTravellerProfileRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _new_traveller_profile_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./new-traveller-profile.component */ "./src/app/layout/profile-management/create-new-profile/new-traveller-profile/new-traveller-profile.component.ts");
...
const routes = [
    { path: '', component: _new_traveller_profile_component__WEBPACK_IMPORTED_MODULE_1__["NewTravellerProfileComponent"] }
];
let NewTravellerProfileRoutingModule = class NewTravellerProfileRoutingModule {
};
NewTravellerProfileRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewTravellerProfileComponent", function() { return NewTravellerProfileComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let NewTravellerProfileComponent = class NewTravellerProfileComponent {
    constructor(route, ProfileManagementService, fb, el) {
        this.route = route;
        ...
        this.createNewTravellerProfile = () => {
            this.newTravellerProfileObj.created = "";
            //this.newTravellerProfileObj.id = "5";
            this.newTravellerProfileObj.traveller_profile_id = this.newTravellerProfileId; //ask Praveen
            this.newTravellerProfileObj.organisation_id = "12";
            // this.newReportForm.get('roleSearch').setValue(value);
            ...
            this.newTravellerProfileObj.customers = "";
            //this.newTravellerProfileObj.customers = this.newTravellerProfileForm.get('customers').value;
            ...
            this.ProfileManagementService.NewTravellerProfile(this.newTravellerProfileObj).subscribe((results) => {
                console.log(results);
            });
        };
        let uniqueProfileID = Math.random().toString(36).substring(7);
        console.log(uniqueProfileID);
        this.newTravellerProfileId = uniqueProfileID + "Amedius";
        //alert(this.newTravellerProfileId);
        this.route.queryParams.subscribe(params => {
            console.log(params);
            this.travellerProfileId = params.traveller_profile_id;
            ...
            let numberDetails = this.parsingArrayParams(params.number_details, this.number_details);
            let addEmail = this.parsingArrayParams(params.add_email, this.add_email);
            let addressDetails = this.parsingArrayParams(params.address_details, this.address_details);
            let customer = this.parsingArrayParams(params.customers, this.customers);
            let agencyOffice = this.parsingArrayParams(params.agency_office, this.agency_office);
            let miscTicketing = this.parsingArrayParams(params.misc_ticketing, this.misc_ticketing);
            let ticketingArrangements = this.parsingArrayParams(params.ticketing_arrangements, this.ticketing_arrangements);
            ...
            let validatingCarrier = this.parsingArrayParams(params.validating_carrier, this.validating_carrier);
            let keywords = this.parsingArrayParams(params.keywords, this.keywords);
            let formOfPayments = this.parsingArrayParams(params.forms_of_payment, this.forms_of_payment);
            ...
            let commision = this.parsingArrayParams(params.commision, this.commission);
            ...
            let priorityLines = this.parsingArrayParams(params.priority_lines, this.priority_lines);
            ...
            let frequentFlyers = this.parsingArrayParams(params.frequent_flyers, this.frequent_flyers);
            let seatingPreference = this.parsingArrayParams(params.seating_preferences, this.seating_preferences);
            let airlinePreference = this.parsingArrayParams(params.airline_preferrences, this.airline_preferrences);
        });
        $(document).ready(() => {
            $('.ui.rating').rating();
        });
    ...
    initAirlinePreference() {
        return {
            prefered_airline: ['']
        };
    }
    get airline_preferrences() {
    ...
    removeTicketingArrangement(index) {
    ...
    UpdateTravellerProfile() {
        ...
        this.ProfileManagementService.UpdateTravellerProfile(this.travellerProfileId, this.newTravellerProfileObj).subscribe((results) => {
            console.log(results);
        });
    }
    setActiveTab(label) {
...
NewTravellerProfileComponent.ctorParameters = () => [
...
NewTravellerProfileComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-new-traveller-profile',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./new-traveller-profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/profile-management/create-new-profile/new-traveller-profile/new-traveller-profile.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./new-traveller-profile.component.scss */ "./src/app/layout/profile-management/create-new-profile/new-traveller-profile/new-traveller-profile.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewTravellerProfileModule", function() { return NewTravellerProfileModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _new_traveller_profile_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./new-traveller-profile.component */ "./src/app/layout/profile-management/create-new-profile/new-traveller-profile/new-traveller-profile.component.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _new_traveller_profile_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./new-traveller-profile-routing.module */ "./src/app/layout/profile-management/create-new-profile/new-traveller-profile/new-traveller-profile-routing.module.ts");
...
let NewTravellerProfileModule = class NewTravellerProfileModule {
    constructor() {
    }
};
NewTravellerProfileModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_new_traveller_profile_component__WEBPACK_IMPORTED_MODULE_1__["NewTravellerProfileComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"],
            _new_traveller_profile_routing_module__WEBPACK_IMPORTED_MODULE_5__["NewTravellerProfileRoutingModule"],
...
//# sourceMappingURL=new-traveller-profile-new-traveller-profile-module-es2016.js.map