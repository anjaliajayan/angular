...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["retrieve-profile-retrieve-profile-module"], {
  ...
  function srcAppLayoutProfileManagementRetrieveProfileRetrieveProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RetrieveProfileComponent =
    /*#__PURE__*/
    function () {
      function RetrieveProfileComponent(ProfileManagementService, router) {
        _classCallCheck(this, RetrieveProfileComponent);

        this.ProfileManagementService = ProfileManagementService;
        this.router = router; // @ViewChild('sampleT', { static: true }) public sampleT: TemplateRef<any>;
      ...
      _createClass(RetrieveProfileComponent, [{
        key: "getJSONval",
        value: function getJSONval(value) {
          var addressStr = "";

          if (value) {
            var address = JSON.parse("".concat(value));
            address.map(function (adr) {
              addressStr += " ".concat(adr.address);
            });
          }
        ...
        key: "getJSONvalStreet",
        value: function getJSONvalStreet(value) {
          var addressStr = "";

          if (value) {
            var address = JSON.parse("".concat(value));
            address.map(function (adr) {
              addressStr += " ".concat(adr.street);
            });
          }
        ...
        key: "getJSONvalpostal",
        value: function getJSONvalpostal(value) {
          var addressStr = "";

          if (value) {
            var address = JSON.parse("".concat(value));
            address.map(function (adr) {
              addressStr += " ".concat(adr.postalCode);
            });
          }
        ...
        key: "getJSONvalcity",
        value: function getJSONvalcity(value) {
          var addressStr = "";

          if (value) {
            var address = JSON.parse("".concat(value));
            address.map(function (adr) {
              addressStr += " ".concat(adr.city);
            });
          }
        ...
        key: "getJSONvalcountry",
        value: function getJSONvalcountry(value) {
          var addressStr = "";

          if (value) {
            var address = JSON.parse("".concat(value));
            address.map(function (adr) {
              addressStr += " ".concat(adr.countryList);
            });
          }
        ...
        key: "companyEdit",
        value: function companyEdit(valObj) {
        ...
        key: "groupEdit",
        value: function groupEdit(valObj) {
        ...
        key: "agencyEdit",
        value: function agencyEdit(valObj) {
        ...
        value: function Delete(valObj) {
          console.log(valObj.traveller_profile_id); // alert(valObj.traveller_profile_id);
          ...
          this.ProfileManagementService.DeleteTravellerById(valObj.traveller_profile_id).subscribe(function (res) {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Oops', "Something bad happened at our end. ".concat(err), 'error');
          });
        }
      }, {
        key: "companyDelete",
        value: function companyDelete(valObj) {
          console.log(valObj.company_profile_id); // alert(valObj.company_profile_id);

          this.ProfileManagementService.DeleteCompanyById(valObj.company_profile_id).subscribe(function (res) {
            if (res.status == 200) {
              console.log("This is the response" + JSON.stringify(res));
            }
          }, function (err) {
        ...
        key: "groupDelete",
        value: function groupDelete(valObj) {
          console.log(valObj.group_profile_id); // alert(valObj.group_profile_id);

          this.ProfileManagementService.DeleteGroupById(valObj.group_profile_id).subscribe(function (res) {
            if (res.status == 200) {
              console.log("This is the response" + JSON.stringify(res));
            }
          }, function (err) {
        ...
        key: "agencyDelete",
        value: function agencyDelete(valObj) {
          console.log(valObj.agency_profile_id); // alert(valObj.agency_profile_id);

          this.ProfileManagementService.DeleteAgencyById(valObj.agency_profile_id).subscribe(function (res) {
            if (res.status == 200) {
              console.log("This is the response" + JSON.stringify(res));
            }
          }, function (err) {
        ...
        key: "fetchAllTravellerProfile",
        value: function fetchAllTravellerProfile(limit, pageIndex) {
          var _this = this;

          this.ProfileManagementService.GetAllTraveller(0, limit, pageIndex).subscribe(function (res) {
            if (res.status == 200) {
              _this.totalTravellerProfile = res.traveller;
              _this.pages = _this.totalTravellerProfile / _this.limit;
              _this.NewTravellerProfile = res.traveller;

              _this.NewTravellerProfile.map(function (element, key) {
                if (element.address_details) {
                  var doJson = JSON.parse(element.address_details);
              ...
              console.log("Check this data totalTravellerProfile", _this.NewTravellerProfile);
            }
          }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Oops', "Something bad happened at our end. ".concat(err), 'error');
          });
        ...
        key: "fetchAllCompanyProfile",
        value: function fetchAllCompanyProfile(limit, pageIndex) {
          var _this2 = this;

          this.ProfileManagementService.GetAllCompanies(0, limit, pageIndex).subscribe(function (res) {
            if (res.status == 200) {
              _this2.totalCompanyProfile = res.CompanyProfile;
              _this2.pages = _this2.totalCompanyProfile / _this2.limit;
              _this2.NewCompanyProfile = res.CompanyProfile;
            }
          }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Oops', "Something bad happened at our end. ".concat(err), 'error');
          });
        ...
        key: "fetchAllGroupProfile",
        value: function fetchAllGroupProfile(limit, pageIndex) {
          var _this3 = this;

          this.ProfileManagementService.GetAllGroups(0, limit, pageIndex).subscribe(function (res) {
            if (res.status == 200) {
              _this3.totalGroupProfile = res.GroupProfile;
              _this3.pages = _this3.totalGroupProfile / _this3.limit;
              _this3.NewGroupProfile = res.GroupProfile;
            }
          }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Oops', "Something bad happened at our end. ".concat(err), 'error');
          });
        ...
        key: "fetchAllAgencyProfile",
        value: function fetchAllAgencyProfile(limit, pageIndex) {
          var _this4 = this;

          this.ProfileManagementService.GetAllAgencies(0, limit, pageIndex).subscribe(function (res) {
            if (res.status == 200) {
              _this4.totalAgencyProfile = res.AgencyProfile;
              _this4.pages = _this4.totalAgencyProfile / _this4.limit;
              _this4.NewAgencyProfile = res.AgencyProfile;
            }
          }, function (err) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Oops', "Something bad happened at our end. ".concat(err), 'error');
          });
  ...
  function srcAppLayoutProfileManagementRetrieveProfileRetrieveProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_services_profile_management_profile_management_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../../shared/services/profile-management/profile-management.service */
    "./src/app/shared/services/profile-management/profile-management.service.ts");
    /* harmony import */


    var _retrieve_profile_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    RetrieveProfileModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _retrieve_profile_routing_module__WEBPACK_IMPORTED_MODULE_7__["RetrieveProfileRoutingModule"], ngx_moment__WEBPACK_IMPORTED_MODULE_5__["MomentModule"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_4__["NgxDatatableModule"]],
      providers: [_shared_services_profile_management_profile_management_service__WEBPACK_IMPORTED_MODULE_6__["ProfileManagementService"]]
