...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["report-report-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppLayoutReportReportComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLayoutReportReportRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var routes = [{
      ...
      children: [{
        path: '',
        redirectTo: 'booking-report',
        pathMatch: 'prefix'
      }, {
        path: 'booking-report',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | booking-report-booking-report-module */
          [__webpack_require__.e("default~airline-deals-airline-deals-module~audit-report-audit-report-module~booking-report-booking-r~d6069c4c"), __webpack_require__.e("default~activities-activities-module~booking-report-booking-report-module~bookings-bookings-module~e~58a6e317"), __webpack_require__.e("default~booking-report-booking-report-module~bookings-bookings-module~dynamic-report-dynamic-report-~09342fdb"), __webpack_require__.e("common"), __webpack_require__.e("booking-report-booking-report-module")]).then(__webpack_require__.bind(null,
          /*! ./booking-report/booking-report.module */
          "./src/app/layout/report/booking-report/booking-report.module.ts")).then(function (m) {
            return m.BookingReportModule;
          });
        }
      }, {
        path: 'segment-report',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | segment-report-segment-report-module */
          [__webpack_require__.e("default~airline-deals-airline-deals-module~audit-report-audit-report-module~booking-report-booking-r~d6069c4c"), __webpack_require__.e("segment-report-segment-report-module")]).then(__webpack_require__.bind(null,
          /*! ./segment-report/segment-report.module */
          "./src/app/layout/report/segment-report/segment-report.module.ts")).then(function (m) {
            return m.SegmentReportModule;
          });
        }
      }, {
        path: 'mis-report',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | mis-report-mis-report-module */
          [__webpack_require__.e("default~mis-report-mis-report-module~view-user-view-user-module"), __webpack_require__.e("mis-report-mis-report-module")]).then(__webpack_require__.bind(null,
          /*! ./mis-report/mis-report.module */
          "./src/app/layout/report/mis-report/mis-report.module.ts")).then(function (m) {
            return m.MISReportModule;
          });
        }
      }, {
        path: 'audit-report',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | audit-report-audit-report-module */
          [__webpack_require__.e("default~airline-deals-airline-deals-module~audit-report-audit-report-module~booking-report-booking-r~d6069c4c"), __webpack_require__.e("audit-report-audit-report-module")]).then(__webpack_require__.bind(null,
          /*! ./audit-report/audit-report.module */
          "./src/app/layout/report/audit-report/audit-report.module.ts")).then(function (m) {
            return m.AuditReportModule;
          });
        }
      }, {
        path: 'dynamic-report',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | dynamic-report-dynamic-report-module */
          [__webpack_require__.e("default~booking-report-booking-report-module~bookings-bookings-module~dynamic-report-dynamic-report-~09342fdb"), __webpack_require__.e("dynamic-report-dynamic-report-module")]).then(__webpack_require__.bind(null,
          /*! ./dynamic-report/dynamic-report.module */
          "./src/app/layout/report/dynamic-report/dynamic-report.module.ts")).then(function (m) {
            return m.DynamicReportModule;
          });
        }
      }, {
        path: 'ticket-report',
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("default~airline-deals-airline-deals-module~audit-report-audit-report-module~booking-report-booking-r~d6069c4c"), __webpack_require__.e("default~booking-report-booking-report-module~bookings-bookings-module~dynamic-report-dynamic-report-~09342fdb"), __webpack_require__.e("common"), __webpack_require__.e("ticket-report-ticket-report-module")]).then(__webpack_require__.bind(null,
          /*! ./ticket-report/ticket-report.module */
          "./src/app/layout/report/ticket-report/ticket-report.module.ts")).then(function (m) {
            return m.TicketReportModule;
          });
        }
      }, {
        path: 'search-log-report',
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | search-log-report-search-log-report-module */
          [__webpack_require__.e("default~airline-deals-airline-deals-module~audit-report-audit-report-module~booking-report-booking-r~d6069c4c"), __webpack_require__.e("search-log-report-search-log-report-module")]).then(__webpack_require__.bind(null,
          /*! ./search-log-report/search-log-report.module */
          "./src/app/layout/report/search-log-report/search-log-report.module.ts")).then(function (m) {
            return m.SearchLogReportModule;
          });
        }
      }]
    }];
  ...
  /***/
  function srcAppLayoutReportReportComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLayoutReportReportComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ReportComponent(fb, newReportService) {
    ...
    ReportComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/report/report.component.html")).default,
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./report.component.scss */
      "./src/app/layout/report/report.component.scss")).default]
    })], ReportComponent);
    /***/
  },
  ...
  /***/
  function srcAppLayoutReportReportModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    ReportModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _report_routing_module__WEBPACK_IMPORTED_MODULE_5__["ReportRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]]
    })], ReportModule);
    /***/
  }
}]);
