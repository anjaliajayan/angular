...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["markup-configuration-markup-configuration-module"], {
    ...
    function () {
      ...
      _createClass(MarkComponent, [{
        ...
        value: function fetchAllMarkups(filterParams) {
          ...
          this.MarkupConfigurationService.GetAllMarkups(this.filterParams).subscribe(function (res) {
            if (res.status) {
  ...
  function srcAppLayoutSetupConfigurationMarkupConfigurationMarkupConfigurationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MarkupConfigurationComponent =
    /*#__PURE__*/
    function () {
  ...
  function srcAppLayoutSetupConfigurationMarkupConfigurationMarkupConfigurationModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _markup_configuration_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./markup-configuration-routing.module */
    "./src/app/layout/setup-configuration/markup-configuration/markup-configuration-routing.module.ts");
    /* harmony import */


    var _markup_configuration_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./markup-configuration.component */
    "./src/app/layout/setup-configuration/markup-configuration/markup-configuration.component.ts");
    /* harmony import */


    var _mark_mark_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./mark/mark.component */
    "./src/app/layout/setup-configuration/markup-configuration/mark/mark.component.ts");
    /* harmony import */


    var _sale_sale_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./sale/sale.component */
    "./src/app/layout/setup-configuration/markup-configuration/sale/sale.component.ts");
    /* harmony import */


    var _sale_addgroup_addgroup_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var _mark_addmarkup_addmarkup_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    MarkupConfigurationModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _markup_configuration_routing_module__WEBPACK_IMPORTED_MODULE_6__["MarkupConfigurationRoutingModule"], ngx_moment__WEBPACK_IMPORTED_MODULE_4__["MomentModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_3__["NgxDatatableModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_12__["MatDatepickerModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_14__["MatFormFieldModule"], _angular_material_core__WEBPACK_IMPORTED_MODULE_13__["MatNativeDateModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_17__["MatInputModule"], _angular_material_chips__WEBPACK_IMPORTED_MODULE_15__["MatChipsModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_16__["MatIconModule"], _angular_material_autocomplete__WEBPACK_IMPORTED_MODULE_18__["MatAutocompleteModule"]]
      ...
      _createClass(AddGroupComponent, [{
        ...
        value: function addGroup(event) {
          ...
          this.MarkupConfigurationService.AddGroup(formParams).subscribe(function (res) {
            if (res.status == true) {
              ...
              _this17.toastr.success("Group added...!!!", "Success ", {
                timeOut: 10000,
                progressBar: false,
                positionClass: 'toast-bottom-right'
              });
        ...
        value: function fetchAllPOS(data) {
          ...
          this.posService.fetchAllPointofSale(data).subscribe(function (res) {
            if (res.status) {
              _this18.allPos = res.result.data;
            }
          }, function (err) {
            console.log('erer ', err);
          });
        ...
        value: function onUpdateGroup(data) {
          ...
          this.MarkupConfigurationService.editGroup(formParams).subscribe(function (res) {
            if (res.status) {
              ...
              _this20.toastr.success("Group updateddddddddddd...!!!", "Success ", {
                timeOut: 10000,
                progressBar: false,
                positionClass: 'toast-bottom-right'
              });
