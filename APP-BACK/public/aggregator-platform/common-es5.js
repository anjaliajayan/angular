...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppLayoutCountryListCountryListModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CountryListModule = CountryListModule_1 = /*#__PURE__*/function () {
  ...
  /***/
  function srcAppSharedServicesActivityServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ActivitySearchService", function () {
    ...
    var ActivitySearchService = /*#__PURE__*/function () {
      function ActivitySearchService(http) {
        _classCallCheck(this, ActivitySearchService);
      ...
      _createClass(ActivitySearchService, [{
        key: "searchActivity",
        value: function searchActivity(searchData) {
          return this.http.post("".concat(this.url, "/api/activities"), searchData);
        }
      }, {
        key: "activityDetails",
        value: function activityDetails(details) {
          return this.http.post("".concat(this.url, "/api/activities/details"), details);
        }
      }, {
        key: "BlockRequest",
        value: function BlockRequest(block) {
          return this.http.post("".concat(this.url, "/api/activities/block"), block);
        }
      }, {
        key: "orderCreateRequest",
        value: function orderCreateRequest(book) {
          return this.http.post("".concat(this.url, "/api/activities/book"), book);
        }
      }, {
        key: "orderCancelRequest",
        value: function orderCancelRequest(cancel) {
          return this.http.post("".concat(this.url, "/api/activities/cancel"), cancel);
        }
      }, {
        key: "orderReteriveRequest",
        value: function orderReteriveRequest(reterive) {
          return this.http.post("".concat(this.url, "/api/activities/orderreterive"), reterive);
        }
      }, {
        key: "activitySendVoucher",
        value: function activitySendVoucher(voucher) {
          return this.http.post("".concat(this.url, "/api/activities/booking-voucher-send"), voucher);
        }
      }]);
    ...
    ActivitySearchService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]
      }];
    };

    ActivitySearchService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Injectable"])({
      providedIn: 'root'
  ...
  function srcAppSharedServicesCommonServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CommonService = /*#__PURE__*/function () {
      ...
      _createClass(CommonService, [{
        ...
        key: "makeTransaction",
        value: function makeTransaction(pramas) {
          return this.http.post("".concat(this.url, "/api//make-agent-transaction"), pramas);
        }
      }]);
  ...
  function srcAppSharedServicesFlightSearchServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FlightSearchService = /*#__PURE__*/function () {
      ...
      _createClass(FlightSearchService, [{
        ...
        key: "searchFlightStatic",
        value: function searchFlightStatic(searchData) {
          return this.http.post("".concat(this.url, "air-shoppingStatic"), searchData);
        }
      }, {
        ...
        key: "orderRetrieveRequest",
        value: function orderRetrieveRequest(_tripId) {
          return this.http.get("".concat(this.url, "order-retrieve/").concat(_tripId));
        }
      }, {
        ...
        value: function cancelTicketRequest(_tripId, _serviceFee) {
          return this.http.post("".concat(this.url, "booking-cancel"), {
            tripId: _tripId,
        ...
        value: function voidTicketRequest(tripId) {
          return this.http.get("".concat(this.url, "booking-void/").concat(tripId));
        }
      }, {
        key: "bookingRefundConfirmRequest",
        value: function bookingRefundConfirmRequest(tripId) {
          return this.http.get("".concat(this.url, "refund_confirm/").concat(tripId));
        }
      }, {
        key: "refundTicketRequest",
        value: function refundTicketRequest(_tripId, amountToRefund, _serviceFee) {
          return this.http.post("".concat(this.url, "refund"), {
            tripId: _tripId,
        ...
        key: "fetchAllChildPos",
        value: function fetchAllChildPos() {
          return this.http.get("".concat(this.url2, "get-orgranisation-child-list"));
        }
      }, {
        key: "fetchPosById",
        value: function fetchPosById(orgId) {
          return this.http.get("".concat(this.url2, "get-orgranisation-by-id/").concat(orgId));
        }
      }, {
  ...
  function srcAppSharedServicesProfileManagementProfileManagementServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfileManagementService = /*#__PURE__*/function () {
      ...
      _createClass(ProfileManagementService, [{
        ...
        value: function NewTravellerProfile(data) {
          return this.http.post("".concat(this.url, "/api/create-new-traveller-profile"), data);
        }
      }, {
        key: "NewGroupProfile",
        ...
        key: "profileSearch",
        value: function profileSearch(filterData) {
          return this.http.post("".concat(this.url, "/api/search-traveller"), filterData);
        }
      }, {
        key: "UpdateCreateProfile",
        value: function UpdateCreateProfile(data) {
          return this.http.post("".concat(this.url, "/api/update-new-traveller-profile"), data);
        ...
        value: function GetAllTraveller(travellID, limit, pageIndex) {
          return this.http.get("".concat(this.url, "/api/fetch-all-traveller-profile")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
        }
      }, {
        key: "GetAllCompanies",
        ...
        value: function UpdateTravellerProfile(id, data) {
          return this.http.post("".concat(this.url, "/api/update-new-traveller-profile?traveller_profile_id=") + id, JSON.stringify(data), this.httpOptions) //return this.http.put<NewTravellerProfile>(`${this.url}/api/update-new-traveller-profile` + id, JSON.stringify(data), this.httpOptions)
        ...
        value: function DeleteTravellerById(id) {
          return this.http.post("".concat(this.url, "/api/remove-traveller-profile"), JSON.stringify(id), this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandl));
        }
      }, {
        ...
        value: function GetTravellerById(id) {
          return this.http.get("".concat(this.url, "/api/fetch-new-traveller-profile/").concat(id));
        } // Error handling
  ...
  function srcAppSharedServicesSetupConfigSetupConfigServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SetupConfigService = /*#__PURE__*/function () {
      ...
      _createClass(SetupConfigService, [{
        ...
        key: "searchByCurrencyData",
        value: function searchByCurrencyData(data) {
          return this.http.post("".concat(this.url, "/api/search-currency"), data);
        }
      }, {
