...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~layout-users-users-module~users-users-module"], {
        ...
        value: function btnSubmitHandler() {
          ...
          this.userService.updateUser(data).subscribe(function (r) {
            if (r.status) {
              ...
              _this.toastr.error("".concat(r.message), "", {
                timeOut: 1000,
                progressBar: false,
                positionClass: 'toast-bottom-right'
              });
  ...
  function srcAppLayoutUsersUserNewUserNewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_services_pos_service_pos_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/shared/services/pos-service/pos-service */
    "./src/app/shared/services/pos-service/pos-service.ts");

    var UserNewComponent = /*#__PURE__*/function () {
      function UserNewComponent(router, _fb, userService, commonService, toastr, posService) {
      ...
      _createClass(UserNewComponent, [{
        ...
        value: function btnSubmitHandler() {
          ...
          this.userService.createUser(this.newUserForm.value).subscribe(function (r) {
            if (r.status) {
              _this7.toastr.success(r.msg, '', {
                disableTimeOut: false,
                progressBar: false,
                positionClass: 'toast-bottom-right'
              });
              ...
              // this.buildError(r.msg);
              _this7.toastr.error("".concat(r.message), "", {
                timeOut: 1000,
                progressBar: false,
                positionClass: 'toast-bottom-right'
              });
        ...
        value: function getOrgBranches(id) {
          ...
          this.posService.fetchAllBranches(id).subscribe(function (result) {
            if (result.status) {
              _this11.branches = result.result.data;
            } else {
        ...
        value: function validatePassword() {
          ...
          var hasError = password.value !== cpassword.value;
  ...
  function srcAppLayoutUsersUserTargetsUserTargetsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserTargetsComponent = /*#__PURE__*/function () {
      function UserTargetsComponent(_fb, userService, toastr, activatedRoute, router) {
      ...
      _createClass(UserTargetsComponent, [{
        ...
        value: function getUser(userId) {
          ...
          this.userService.fetchUser(userId).subscribe(function (r) {
            if (r.status == 200) {
              var target_amount = JSON.parse(r.data.target_amount);

              if (target_amount) {
                _this12.getTargetArray.removeAt(0);

                target_amount.forEach(function (x) {
                  _this12.getTargetArray.push(_this12._fb.group(x));
                });
              } else {
                target_amount.forEach(function (x) {
                  _this12.getTargetArray.push(_this12._fb.group(x));
        ...
        value: function btnSubmitHandler() {
          ...
          this.userService.saveTargets(targets).subscribe(function (r) {
            if (r.status) {
              _this13.toastr.success(r.message, 'Success !', {
                disableTimeOut: false,
                progressBar: false,
                positionClass: 'toast-bottom-right'
              });
              ...
              _this13.buildError(r.msg);
            }
          }, function (apiError) {
            _this13.buildError(apiError.error.message);
          });
          console.log(targets);
          return false;
        }
        ...
        key: "btnRemoveTarget",
        value: function btnRemoveTarget(index) {
  ...
  function srcAppLayoutUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UsersComponent = /*#__PURE__*/function () {
      function UsersComponent(router, _fb, userService, toastr, commonService) {
      ...
      _createClass(UsersComponent, [{
        ...
        key: "fetchAllsUsers",
        value: function fetchAllsUsers() {
          var _this14 = this;

          this.userService.GetAllUsers(this.userConfigForm).subscribe(function (res) {
            if (res.status) {
              _this14.totalListOfUsers = res.result.total;
              _this14.userPage = res.result.page;
              _this14.usersList = res.result.data;
            } else {
              _this14.toastr.error("".concat(res.msg), "".concat(res.msg), {
                timeOut: 1000,
                progressBar: false,
                positionClass: 'toast-bottom-right'
              });
        ...
        value: function organizationList() {
          ...
          this.commonService.getOrganizationList().subscribe(function (result) {
            _this15.organizations = result.listData.filter(function (data) {
              return data.name != null;
            });
            _this15.organizations = _this15.organizations.filter(function (data) {
              return data.name !== "";
            });
          });
        }
        ...
        value: function searchFormSubmit() {
          this.formIsSubmitted = true;
          console.log("searchUserForm::::::::::", this.searchUserForm.value); // this.filterParams.page = 0;
        ...
        value: function statusToggle(data) {
          ...
          this.userService.onStatusToggle(this.toggleObj).subscribe(function (res) {
            if (res.status == 200) {
              _this16.fetchAllsUsers();
            } else {
        ...
        value: function deleteUser(valObj) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
            ...
            if (result.value) {
              _this17.userService.deleteUser(valObj.users_id).subscribe(function (result) {
  ...
  function srcAppLayoutUsersUsersModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    UsersModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _users_routing_module__WEBPACK_IMPORTED_MODULE_4__["UsersRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_9__["NgxDatatableModule"]]
    })], UsersModule);
    /***/
  },
      ...
      _createClass(UserService, [{
        ...
        value: function fetchPermissions() {
          ...
          return this.http.get("".concat(this.apiUrl, "/api/users/permissions")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (result) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this25, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
        ...
        value: function saveTargets(data) {
          ...
          return this.http.post("".concat(this.apiUrl, "/api/users/target"), data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (result) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this26, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
