...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["create-user-create-user-module"], {
  ...
  function srcAppLayoutUserRoleManagementCreateUserCreateUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CreateUserComponent = /*#__PURE__*/function () {
      function CreateUserComponent(cd, toastr, userRoleService, formBuilder, commonService, router, orgHierarchyService) {
        ...
        this.submittedCorp = false; // seatPreference: any = seatPreference;
      ...
      _createClass(CreateUserComponent, [{
        ...
        value: function countryList() {
          ...
          this.commonService.getCountryList().subscribe(function (result) {
            ...
            console.log("this.countries::::::: ", _this3.countries);
          });
        } // get agents
  ...
  function srcAppSharedServicesOrganizationOrganizationHierarchyServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var OrganizationHierarchyService = /*#__PURE__*/function () {
