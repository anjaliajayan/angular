...
/* harmony import */ var _shared_services_dashboard_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../../shared/services/dashboard.service */ "./src/app/shared/services/dashboard.service.ts");
/* harmony import */ var _shared_services_pointsale_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../../../shared/services/pointsale.service */ "./src/app/shared/services/pointsale.service.ts");
...
let GraphsComponent = class GraphsComponent {
    constructor(dashboardService, posService) {
        this.dashboardService = dashboardService;
        this.posService = posService;
        this.bookingsLoader = true;
        this.organisationLoader = true;
        this.performance_type = false;
        // presetInfo: any = {
        //   active: 0,
        //   inactive: 0,
        //   subagents: 0,
    ...
    ngOnInit() {
        ...
        this.dashboardService.fetchFlightInformation()
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Oops', `Something bad happened at our end. ${err}`, 'error');
        });
    ...
    ngOnChanges(changes) {
        const bookings = changes.bookings;
        const performanceInfo = changes.performanceInfo;
        const marginInfo = changes.marginInfo;
        const presetInfo = changes.presetInfo;
        if (bookings) {
...
], GraphsComponent.prototype, "bookings", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"])()
], GraphsComponent.prototype, "presetInfo", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"])()
], GraphsComponent.prototype, "performanceInfo", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"])()
], GraphsComponent.prototype, "marginInfo", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"])("bookingsLoader")
], GraphsComponent.prototype, "bookingsLoader", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"])("organisationLoader")
], GraphsComponent.prototype, "organisationLoader", void 0);
GraphsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-graphs',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./graphs.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/dashboard/components/graphs/graphs.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./graphs.component.scss */ "./src/app/layout/dashboard/components/graphs/graphs.component.scss")).default]
    })
], GraphsComponent);
...
/* harmony import */ var src_app_shared_services_organization_organization_h_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/shared/services/organization/organization-h.service */ "./src/app/shared/services/organization/organization-h.service.ts");
/* harmony import */ var src_app_shared_services_user_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/services/user.services */ "./src/app/shared/services/user.services.ts");
...
let DashboardComponent = class DashboardComponent {
    constructor(fb, orgService, userService, dashboardService, toastr) {
        this.fb = fb;
        ...
        this.bookings = { "total": 0, "flights": 0, "hotels": 0, "insurance": 0, "activities": 0, "carHire": 0, "transfers": 0, "holidays": 0, "cruise": 0 };
        this.presetInfo = { "subagents": 0, "websites": 0, "corporates": 0, "total": 0, "active": 0, "inactive": 0 };
    ...
    getOrganizationList() {
        this.orgService
            .GetAllOrganization()
            .subscribe((result) => (this.organizations = result.Organization, this.filteredOrganizations = result.Organization));
    }
    getUserList(orgID = '') {
        this.userService
    ...
    calculateMarginfromPerformance() {
        ...
        var output = { tags: performance.tags, margin: [] };
...
/* harmony import */ var _components_graphs_graphs_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/graphs/graphs.component */ "./src/app/layout/dashboard/components/graphs/graphs.component.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrganizationHService", function() { return OrganizationHService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let OrganizationHService = class OrganizationHService {
    constructor(http) {
        this.http = http;
    ...
    fetchOrganizationDetails(id) {
        return this.http.get(`${this.url}/api/fetch-organization-details?hierarchy_id=` + id, this.httpOptions)
    ...
    CreateOrganization(data) {
        return this.http.post(`${this.url}/api/create-organization`, data, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    UpdateOrganization(data) {
        return this.http.post(`${this.url}/api/update-organization`, data, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    //Fetch all organization
    GetAllOrganization(tourID, limit, pageIndex) {
        return this.http
            .get(`${this.url}/api/fetch-all-organization`, { withCredentials: true })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    //Fetch all organization
    GetAllOrganizationHierarchy(tourID, limit, pageIndex) {
        return this.http
            .get(`${this.url}/api/fetch-all-Hierarchy`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    //update Organization Hierarchy
    UpdateOrganizationHierarchy(data) {
        return this.http.post(`${this.url}/api/update-organization-heirarchy`, JSON.stringify(data), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    CreateOrganizationHierarchy(data) {
        return this.http.post(`${this.url}/api/create-organization-hierarchy`, JSON.stringify(data), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    fetchActiveSuppliers() {
        return this.http.get(`${this.url}/api/fetch_supplier_pos`, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    updateOrganizationSupplier(data) {
        return this.http.post(`${this.url}/api/organization_vat`, JSON.stringify(data), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    updateOrganizationVat(data) {
        return this.http.post(`${this.url}/api/update_supplier_pos`, JSON.stringify(data), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.errorHandl));
    }
    // Error handling
    errorHandl(error) {
...
OrganizationHService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
];
OrganizationHService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=dashboard-dashboard-module-es2016.js.map