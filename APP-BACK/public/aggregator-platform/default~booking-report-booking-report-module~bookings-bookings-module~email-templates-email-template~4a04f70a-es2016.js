...
let ModalService = class ModalService {
    ...
    seat(id, data) {
        ...
        this.seatMapId = id;
        // this.sampleId.next(this.seatMapJson);
...
//# sourceMappingURL=default~booking-report-booking-report-module~bookings-bookings-module~email-templates-email-template~4a04f70a-es2016.js.map